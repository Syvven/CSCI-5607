...
Unfortunately, .ppm files cannot be embedded, so these are actually .png's <br>
Also, its worth noting that a few of these cannot be obtained through simply modifying the input file. <br>
Specifically, the perlin noise, some of the SPH, and some of the combo ones. <br>
They were generated by modifying some constants in the code. <br>
I apologize for not making it more customizable, I have spent more than enough time on it as it is. <br>
Those constants will be marked.
